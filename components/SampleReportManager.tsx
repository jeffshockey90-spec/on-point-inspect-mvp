    ...
    <section className="mb-8 max-w-full overflow-hidden rounded-2xl border border-teal-500/40 bg-teal-950/20 p-4 shadow-xl">
      <div className="flex max-w-full flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
        <div className="min-w-0">
          <p className="break-words text-xs font-black uppercase tracking-[0.25em] text-teal-300">
        ...
        <span
          className={`w-fit shrink-0 rounded-full border px-4 py-2 text-xs font-black uppercase tracking-wide ${
            enabled
      ...
      <div className="mt-5 grid max-w-full gap-4 lg:grid-cols-[260px_minmax(0,1fr)]">
        <label className="flex min-w-0 max-w-full flex-col gap-3 rounded-2xl border border-slate-700 bg-[#020817] p-4 sm:flex-row sm:items-start">
          <input
            type="checkbox"
            checked={enabled}
        ...
        <div className="grid min-w-0 max-w-full gap-3 md:grid-cols-2">
          <label className="block min-w-0">
            <p className="mb-2 break-words text-xs font-black uppercase tracking-wide text-slate-400">
              Sample Report Title
            </p>
            <input
              value={title}
              ...
              className="w-full min-w-0 rounded-xl border border-slate-700 bg-[#020817] p-3 text-white outline-none focus:border-teal-400"
            />
          </label>
      ...
      {publicShareUrl && (
        <p className="mt-4 max-w-full break-all rounded-xl border border-slate-700 bg-[#020817] p-3 text-xs font-bold text-slate-300">
