...
export default function SignaturePad({
  ...
  return (
    <div>
      <div
        ref={wrapRef}
        className="relative h-44 w-full overflow-hidden rounded-xl border border-slate-700 bg-white"
      >
        <canvas
          ref={canvasRef}
        ...
        {isEmpty && (
          <div className="pointer-events-none absolute inset-0 flex items-center justify-center">
            <span className="select-none text-sm font-semibold text-slate-400">
      ...
      <div className="mt-2 flex items-center justify-between">
        ...
        <button
          ...
          className="rounded-lg border border-slate-600 px-3 py-1.5 text-xs font-bold text-slate-300 transition hover:bg-slate-800 disabled:cursor-not-allowed disabled:opacity-40"
        >
          Clear
        </button>
      </div>
