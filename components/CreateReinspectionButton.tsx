  ...
  return (
    <span className="inline-flex flex-col">
      <button
        ...
        onClick={create}
        disabled={busy}
        className="inline-flex items-center gap-2 rounded-xl border border-slate-600 px-5 py-3 font-bold text-slate-200 transition hover:border-teal-400 hover:bg-teal-500/10 hover:text-teal-200 disabled:opacity-60"
      >
