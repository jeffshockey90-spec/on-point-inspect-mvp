...
export default function Navbar({ signedIn = false }: { signedIn?: boolean }) {
  ...
  return (
    <>
      ...
      <nav
        className="fixed inset-x-0 bottom-0 z-[100] border-t border-[var(--fl-line)] bg-[var(--fl-surface)] shadow-2xl shadow-black/60 xl:hidden [transform:translateZ(0)] [will-change:transform]"
