  ...
  return (
    <div className="w-full">
      <div className="flex items-center gap-4">
        <div className="h-20 w-20 shrink-0 overflow-hidden rounded-2xl border border-slate-700 bg-[#020617]">
          {avatar ? (
            <img src={avatar} alt="Realtor" className="h-full w-full object-cover" />
          ) : (
            <div className="flex h-full w-full items-center justify-center text-2xl font-black text-teal-300">
              {initials}
            </div>
          )}
        </div>
        ...
        <div className="min-w-0">
          ...
          {profile.brokerage ? (
            <p className="truncate text-sm text-slate-400">{profile.brokerage}</p>
          ) : null}
          {canEdit && !editing && (
            <button
              type="button"
      ...
      {canEdit && editing && (
        <div className="mt-4 space-y-3 rounded-2xl border border-slate-700 bg-[#0b1220] p-4">
          ...
          <input
            ...
            disabled={saving}
            className="w-full rounded-lg border border-slate-700 bg-black p-2.5 text-sm text-white outline-none focus:border-teal-400 disabled:opacity-60"
          />
          <input
            value={brokerage}
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <button
              ...
              disabled={saving}
              className="rounded-lg border border-slate-600 px-4 py-2 text-sm font-bold text-white transition hover:bg-slate-800 disabled:opacity-60"
            >
              Cancel
            </button>
          </div>
