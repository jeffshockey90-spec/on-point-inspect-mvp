...
export default function InvoiceReminderButton({
  ...
  return (
    <button
      ...
      disabled={loading}
      className="rounded-lg border border-yellow-500 px-3 py-2 text-xs font-black text-yellow-300 transition hover:bg-yellow-500/10 disabled:cursor-not-allowed disabled:opacity-50"
    >
