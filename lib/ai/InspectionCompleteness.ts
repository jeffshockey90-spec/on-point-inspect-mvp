...
const SECTION_REQUIREMENTS: Record<string, SectionRequirement[]> = {
  ...
  Electrical: [
    ...
    },
    {
      ...
      title: "GFCI/AFCI protection reviewed",
      keywords: ["gfci", "gfi", "afci", "arc fault", "ground fault", "receptacle"],
      photoKeywords: ["gfci", "outlet", "receptacle"],
      severity: "info",
      recommendation: "Verify GFCI/AFCI protection where required/visible and document any concerns or limitations.",
    },
    {
      id: "electrical-wiring",
      title: "Visible wiring reviewed",
      keywords: ["wiring", "open junction", "double tap", "double tapped", "conductor", "neutral", "ground", "bonding"],
      photoKeywords: ["wire", "junction", "breaker"],
      severity: "warning",
      recommendation: "Review visible wiring and panel conditions for reportable safety concerns.",
    },
  ],
  Plumbing: [
    {
