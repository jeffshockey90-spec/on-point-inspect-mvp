...
import { getSubscriptionPricing } from "./subscriptionPricing";

// Shared handler for the inspector-subscription checkout. Two routes
// (/api/stripe and /api/stripe/subscription-checkout) call this so the pricing
// logic lives in one place instead of two byte-identical copies.
...
export async function handleSubscriptionCheckout(req: Request) {
