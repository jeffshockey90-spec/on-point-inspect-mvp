        ...
        <div>
          ...
          <div className="space-y-4">
            ...
            <DetailInput
              ...
              onChange={(value) => updateField("realtor_name", value)}
            />

            <DetailInput
              label="Realtor Email"
              value={form.realtor_email}
              onChange={(value) => updateField("realtor_email", value)}
            />
        ...
        <div>
          ...
          <div className="space-y-4">
            ...
            <DetailInput
              ...
              onChange={(value) => updateField("house_style", value)}
            />

            <DetailInput
              label="Roof Style"
              value={form.roof_style}
              onChange={(value) => updateField("roof_style", value)}
            />
            ...
            <DetailInput
              ...
              onChange={(value) => updateField("inspection_method", value)}
            />
