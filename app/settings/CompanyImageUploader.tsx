...
export default function CompanyImageUploader({
  ...
  folder,
  buttonText,
  previewClassName = "h-24 w-24 rounded-2xl border border-[var(--fl-line)] bg-white object-contain p-2",
}: Props) {
    ...
    <div className="min-w-0 rounded-xl border border-[var(--fl-line)] bg-[var(--fl-ground)] p-4 md:col-span-2">
      ...
      <div className="grid gap-4 sm:grid-cols-[1fr_auto] sm:items-start">
        <div className="min-w-0">
          ...
          {helper && (
            <p className="mt-2 max-w-xl text-xs leading-5 text-[var(--fl-faint)]">
              {helper}
            </p>
          )}
