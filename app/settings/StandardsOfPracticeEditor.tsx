      ...
      <div className="grid gap-5 p-5 sm:p-6 md:p-8 lg:grid-cols-[minmax(0,0.8fr)_minmax(0,1.2fr)]">
        <div className="space-y-4">
          ...
          <div className="grid gap-3">
            <label className="grid cursor-pointer grid-cols-[auto_minmax(0,1fr)] gap-3 rounded-2xl border border-slate-700 bg-[#020617] p-4 transition hover:border-cyan-400/70">
              <input
                name="standards_include_in_share"
                type="checkbox"
                checked={includeShare}
                onChange={(event) => setIncludeShare(event.target.checked)}
