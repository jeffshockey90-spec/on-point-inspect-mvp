  ...
  return (
    <main className="min-h-screen bg-[#020617] px-4 py-8 text-white md:px-6 md:py-10">
      <div className="mx-auto max-w-3xl">
        <div className="mb-8">
          <p className="text-sm font-black uppercase tracking-[0.3em] text-teal-400">Personal Settings</p>
          <h1 className="mt-3 text-4xl font-black md:text-5xl">Company Email</h1>
