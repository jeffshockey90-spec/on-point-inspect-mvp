...
export default function DeleteAccountSection() {
  ...
  return (
    <section className="mt-10 rounded-2xl border border-red-500/40 bg-red-500/10 p-6">
      ...
      <label className="mt-5 block text-sm font-medium text-[var(--fl-text)]">
      ...
      <input
        ...
        className="mt-2 w-full rounded-xl border border-red-500/40 bg-[var(--fl-ground)] px-4 py-3 text-[var(--fl-text)] outline-none focus:border-red-400"
        placeholder="DELETE"
      />
