...
<body>
  ...
  <main class="shell">
    <section class="paper">
      ...
      <p class="footer-note">Generated by FLOW for repair negotiation review. Final terms should be confirmed by the parties and their real estate professionals.</p>
    </section>
  </main>
</body>
</html>`;
