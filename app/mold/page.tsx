...
// Lab report field that accepts EITHER a pasted link OR a PDF upload. Labs
// almost always send a PDF, not a URL, so this uploads the file to the same
// public storage bucket used for photos and fills in the resulting link.
