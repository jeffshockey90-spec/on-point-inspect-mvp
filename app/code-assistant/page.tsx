    ...
    <main className="min-h-screen bg-[#0a0e13] px-4 py-8 text-white">
      <div className="mx-auto max-w-3xl space-y-6">
        <div>
          <Link
            href="/"
            className="inline-flex items-center gap-2 text-sm font-semibold text-[#8a93a3] transition hover:text-teal-300"
          >
            <ArrowLeft className="h-4 w-4" strokeWidth={2.5} /> Dashboard
          </Link>
        </div>

        <header className="overflow-hidden rounded-2xl border border-teal-500/30 bg-gradient-to-br from-[#10151e] via-[#10151e] to-[#10151e] p-6 shadow-2xl shadow-teal-950/30 md:p-8">
          ...
          <p className="mt-4 max-w-2xl text-base leading-7 text-[#8a93a3]">
